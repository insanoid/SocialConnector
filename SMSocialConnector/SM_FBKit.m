...
- (void)showAppRequestDialogueWithMessage:(NSString *)message
...
- (void)setSettings {
  ...
  [FBSettings setDefaultAppID:[[NSBundle mainBundle]
                                  objectForInfoDictionaryKey:@"FacebookAppID"]];
  [FBSettings
      setDefaultDisplayName:[[NSBundle mainBundle] objectForInfoDictionaryKey:
                                                       @"FacebookDisplayName"]];
